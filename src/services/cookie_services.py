...
from datetime import datetime, timedelta # Added import for datetime and timedelta
...
class UserSessionManager:
    ...
    def _refresh_existing_session(self, payload: Dict, response: Response, request: Request) -> Dict:
        ...
        user_sessions_services.update_session_activity(session_id, datetime.utcnow()) # datetime.utcnow() needs import
    ...
    def _create_new_session(self, request: Request, response: Response, fingerprint_hash: str) -> Dict:
        ...
        jwt_token_hash = hashlib.sha256( # hashlib needs import
        ...
        session_data = UserSessions(
            ...
            ExpiresAt=datetime.utcnow() + timedelta(days=30), # timedelta needs import
    ...
    def get_current_user_from_request(self, request: Request) -> Dict:
        ...
        # from src.service import user_sessions_services # Removed incorrect import
        session_id = payload.get("session_id")
